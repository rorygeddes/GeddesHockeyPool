...
function PrizeSection() {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
      <div className="p-6">
        <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Prize Breakdown</h2>
...
function EntryFeeSection() {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6">
      <div className="p-6">
        <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Entry Fee</h2>
        <div className="flex items-center justify-between">
          <span className="font-semibold text-gray-800 dark:text-gray-200">Cost per Entry</span>
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
            <p className="font-mono text-lg select-all text-blue-900 dark:text-blue-100">rorygeddes16@gmail.com</p>
          </div>
          <p className="text-gray-700 dark:text-gray-300">
